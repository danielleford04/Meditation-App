...
// 	this.oConfiguration.cellColorScheme = (aConf["cellColorScheme"] != null) ? aConf["cellColorScheme"] : "black";
...
// 	this.oConfiguration.weekStartDay   	= (aConf["weekStartDay"] != null) ? aConf["weekStartDay"] : 0;
...
// 			document.getElementById("calendarOutput").innerHTML = "On " + obj.month + "/" + obj.day + ", I meditated " + " minutes.";
